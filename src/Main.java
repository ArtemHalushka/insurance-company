...
public class Main {
    ...
    public static void main(String[] args) throws InvalidPriceException, InvalidM2Exception, IllegalArgumentException {
        ...
        Customer jina = new Customer("Jina Lopez", "27 September", "Canada", "98492034", "5 Bedroom", 20, 300);
        ...
        } catch (InvalidPriceException | InvalidM2Exception | InvalidInsureObjectException e) {
